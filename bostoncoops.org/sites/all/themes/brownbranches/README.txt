...
// BEGIN INSERT by Oren Robinson get.oren@gmail.com

Brownbranches is a zen subtheme developed for the Boston Community Cooperative's
B.R.A.N.C.H.E.S. co-op expansion and support platform. The site functions like a
classified posting space for renters and tenants, as well as co-op sponsored
events coordination.

Why Zen? It's the most installed theming system on Drupal, and the zenophile
module makes rapid development of themes very convenient. It comes with built-in
wireframing for layout modification testing, and has a rich set of #id.class
tags that make customizations concise, semantic and simple. Plus, it comes with
accessibility features for keyboard-only users and straightforward page
structure.

Virtually all I added here appears as modifications to the templates/ directory 
contents (notably page.tpl.php) and changes to the css/pages.css stylesheet, at
the bottom of the file.

// END INSERT by Oren Robinson 
